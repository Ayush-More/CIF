  ...
  return (
    <div className="bg-[#FCF1E8] py-16">
      <div className="flex justify-between p-6 max-w-7xl mx-auto md:px-10 lg:px-14 xl:px-20">
        <div className="mt-20 w-[49%]">
          <div className="text-[#5A3E2B] font-[500] text-[60px] leading-[51px] heading">
            Care Made for <span className="text-[#EF5744]">You</span>
          </div>
          <div className="text-[#8C746A] mt-[30px] font-[400] text-[20px]">
            Personalized support for every individual’s needs.
          </div>
          <div>
            <div className="bg-[#fff] flex rounded-full w-[93%] mt-[36px] pl-6 pr-1 py-1 h-16 justify-between shadow-2xl">
              <input
                type="text"
            ...
            <div className="flex mt-[56px] justify-between w-[93%]">
